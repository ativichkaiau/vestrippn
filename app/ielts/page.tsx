      ...
      <div className="flex flex-1 overflow-hidden relative z-10">
        ...
        <main className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-6 lg:p-10 pb-32 lg:pb-10 transition-all duration-500">
          <div className="max-w-[1400px] mx-auto space-y-10 lg:space-y-12">
            ...
            <HubIntro
              eyebrow="Language Vault"
              title="Keep your English"
              titleAccent="exam-ready"
              description="The IELTS Hub preserves language resources, vocabulary buffers, writing references, and speaking preparation routes now that the unused modules have been removed."
              primaryHref="#ielts-vault"
