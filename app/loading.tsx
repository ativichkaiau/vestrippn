export default function Loading() {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center bg-[#FAFAFA] text-neutral-900 transition-colors duration-700 dark:bg-[#050505] dark:text-neutral-100">
      <div className="w-[min(88vw,420px)] rounded-[28px] border border-black/5 bg-white/70 p-6 shadow-[0_24px_70px_rgba(0,0,0,0.10)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/5 dark:shadow-[0_24px_70px_rgba(0,0,0,0.55)]">
        ...
        <div className="mt-5 space-y-2">
          {steps.map((step, i) => (
            <div
              key={step}
              className="w09-boot-step flex items-center justify-between gap-3 rounded-2xl bg-black/[0.035] px-3 py-2 text-[10px] font-bold uppercase tracking-[0.18em] text-neutral-500 dark:bg-white/[0.045] dark:text-neutral-400"
