            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
              {results.map((result) => (
                <a 
                  ...
                  href={result.url} 
                  target="_blank" 
                  className="group flex flex-col justify-between p-6 bg-white/60 dark:bg-white/5 backdrop-blur-xl border border-black/5 dark:border-white/5 rounded-[24px] hover:border-amber-500/30 hover:bg-white/90 dark:hover:bg-white/10 transition-all duration-300 active:scale-[0.99] shadow-sm"
                >
                  <div>
